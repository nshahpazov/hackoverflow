...
buf.push("<input type=\"text\" placeholder=\"Заглавие\" name=\"title\" id=\"title\" class=\"form-control\"/>");
jade.debug.shift();
jade.debug.shift();
buf.push("</div>");
jade.debug.shift();
...
buf.push("<textarea placeholder=\"опишете въпроса си тук\" name=\"text\" rows=\"3\" id=\"text\" class=\"form-control\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.shift();
buf.push("</textarea>");
jade.debug.shift();
...
buf.push("<input type=\"text\" placeholders=\"добавете тагове, разделени със запетай\" name=\"tags\" id=\"tags\" class=\"form-control\"/>");
jade.debug.shift();
jade.debug.shift();
buf.push("</div>");
jade.debug.shift();
