...
try {
var buf = [];
var locals_ = (locals || {}),votes_count = locals_.votes_count,answers_count = locals_.answers_count,views_count = locals_.views_count,title = locals_.title,_id = locals_._id,date = locals_.date,author = locals_.author,tags = locals_.tags;jade.debug.unshift({ lineno: 1, filename: jade.debug[0].filename });
...
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
=======
>>>>>>> 3be986e2b708452eff6f75e201f8261ec9e8e30d
jade.debug.unshift({ lineno: 13, filename: jade.debug[0].filename });
