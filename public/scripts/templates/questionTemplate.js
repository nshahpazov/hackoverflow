...
try {
var buf = [];
var locals_ = (locals || {}),votes_count = locals_.votes_count,title = locals_.title,text = locals_.text,date = locals_.date,author = locals_.author,answers_count = locals_.answers_count,views_count = locals_.views_count,tags = locals_.tags;jade.debug.unshift({ lineno: 1, filename: jade.debug[0].filename });
...
buf.push("<div class=\"vote-btns\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.unshift({ lineno: 4, filename: jade.debug[0].filename });
buf.push("<img src=\"images/vote-up.png\" alt=\"\" class=\"vote-up\"/>");
jade.debug.shift();
jade.debug.unshift({ lineno: 5, filename: jade.debug[0].filename });
buf.push("<img src=\"images/vote-down.png\" alt=\"\" class=\"vote-down\"/>");
jade.debug.shift();
jade.debug.shift();
buf.push("</div>");
jade.debug.shift();
jade.debug.unshift({ lineno: 6, filename: jade.debug[0].filename });
buf.push("<div class=\"votes-count\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.unshift({ lineno: 6, filename: jade.debug[0].filename });
